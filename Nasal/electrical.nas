...
var go16l = maketimer(1.0, func(){
	var go16l_out = go16l_rand * getprop("engines/engine[0]/n1") * getprop("an24/Electrical_Panel/sw_go16l") * getprop("an24/Electrical_Panel/go-16l_voltreg");
	interpolate("an24/Electrics/AC_Gen_GO16l_V", go16l_out, 1.0 );
});

var go16r_rand = rand() * 0.2 + 1.05; # 115V +-10V
var go16r = maketimer(1.0, func(){
	var go16r_out = go16r_rand * getprop("engines/engine[1]/n1") * getprop("an24/Electrical_Panel/sw_go16r") * getprop("an24/Electrical_Panel/go-16r_voltreg");
	interpolate("an24/Electrics/AC_Gen_GO16r_V", go16r_out, 1.0 );
});
